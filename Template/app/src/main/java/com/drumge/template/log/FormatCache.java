 ...
 */
// TODO: Before making public move from getDateTimeInstance(Integer,...) to int;
...
abstract class FormatCache<F extends Format> {
	...
	private final ConcurrentMap<MultipartKey, F> cInstanceCache = new ConcurrentHashMap<MultipartKey, F>(
			7);

	private final ConcurrentMap<MultipartKey, String> cDateTimeInstanceCache = new ConcurrentHashMap<MultipartKey, String>(
			7);
	 ...
	 * 
	 * @param pattern
	 *            {@link java.text.SimpleDateFormat} compatible pattern, this
	 *            will not be null.
	 * @param timeZone
